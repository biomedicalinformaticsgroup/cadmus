...
def clean_up_dir(df, failed=False):
    if failed == False:
        ...
        # again for the txts directory
        command = subprocess.getstatusoutput(
            "ls -l ./output/retrieved_parsed_files/htmls/"
        )
        command = list(command)
        command = command[1]
        my_list = str(command).split("\n")
        ...
        for i in range(len(list_to_remove)):
            try:
                os.remove(
                    f"./output/retrieved_parsed_files/htmls/{list_to_remove[i]}.txt.zip"
                )
            except:
                pass
        ...
        # again for the txts directory
        command = subprocess.getstatusoutput(
            "ls -l ./output/retrieved_parsed_files/xmls/"
        )
        command = list(command)
        command = command[1]
        my_list = str(command).split("\n")
        ...
        for i in range(len(list_to_remove)):
            try:
                os.remove(
                    f"./output/retrieved_parsed_files/xmls/{list_to_remove[i]}.txt.zip"
                )
            except:
                pass
        ...
        # again for the txts directory
        command = subprocess.getstatusoutput(
            "ls -l ./output/retrieved_parsed_files/pdfs/"
        )
        command = list(command)
        command = command[1]
        my_list = str(command).split("\n")
        ...
        for i in range(len(list_to_remove)):
            try:
                os.remove(
                    f"./output/retrieved_parsed_files/pdfs/{list_to_remove[i]}.txt.zip"
                )
            except:
                pass
        ...
        # again for the txts directory
        command = subprocess.getstatusoutput(
            "ls -l ./output/retrieved_parsed_files/txts/"
        )
        command = list(command)
        command = command[1]
        my_list = str(command).split("\n")
        ...
        for i in range(len(list_to_remove)):
            try:
                os.remove(
                    f"./output/retrieved_parsed_files/txts/{list_to_remove[i]}.txt.zip"
                )
            except:
                pass
        ...
        # again for the txts directory
        command = subprocess.getstatusoutput(
            "ls -l ./output/retrieved_parsed_files/content_text/"
        )
        command = list(command)
        command = command[1]
        my_list = str(command).split("\n")
        ...
        for i in range(len(list_to_remove)):
            try:
                os.remove(
                    f"./output/retrieved_parsed_files/content_text/{list_to_remove[i]}.txt.zip"
                )
            except:
                pass
    else:
