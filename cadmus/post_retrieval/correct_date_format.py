        ...
        if result_date != []:
            ...
            if os.path.exists(f"{crossref_ouptut_path}{index}.p") == True:
                ...
                if new_date != None:
                    ...
                    if (
                        len(crossref_file["message"]["issued"].get("date-parts")[0])
                        == 3
                    ):
                        # adding the 0 when needed to get the yyyy-mm-dd
                        if (
                            crossref_file["message"]["issued"].get("date-parts")[0][1]
                            > 9
                            and crossref_file["message"]["issued"].get("date-parts")[0][
                                2
                            ]
                            > 9
                        ):
                            new_date = str(
                                str(
                                    crossref_file["message"]["issued"].get(
                                        "date-parts"
                                    )[0][0]
                                )
                                + "-"
                ...
                if new_date != None:
                    if (
                        len(crossref_file["message"]["created"].get("date-parts")[0])
                        == 3
                    ):
                        if (
                            crossref_file["message"]["created"].get("date-parts")[0][1]
                            > 9
                            and crossref_file["message"]["created"].get("date-parts")[
                                0
                            ][2]
                            > 9
                        ):
                            new_date = str(
                                str(
                                    crossref_file["message"]["created"].get(
                                        "date-parts"
                                    )[0][0]
                                )
                                + "-"
