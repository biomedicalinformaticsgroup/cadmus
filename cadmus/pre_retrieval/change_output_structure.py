...
def change_output_structure(df, storage=None):
    ...
    for index, row in df.iterrows():
        ...
        if "wc" in row["html_parse_d"].keys():
            ...
            parse_d.update(
                {
                    "file_path": row["html_parse_d"]["file_path"],
        ...
        if "wc" in row["xml_parse_d"].keys():
            ...
            parse_d.update(
                {
                    "file_path": row["xml_parse_d"]["file_path"],
        ...
        if "wc" in row["pdf_parse_d"].keys():
            ...
            parse_d.update(
                {
                    "file_path": row["pdf_parse_d"]["file_path"],
        ...
        if "wc" in row["plain_parse_d"].keys():
            ...
            parse_d.update(
                {
                    "file_path": row["plain_parse_d"]["file_path"],
