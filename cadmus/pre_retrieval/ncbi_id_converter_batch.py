...
def ncbi_id_converter_batch(retrieved_df, email):
    ...
    for input_list in ["pmid_list", "doi_list", "pmcid_list"]:
        ...
        while start < total:
            ...
            params = {
                "ids": str(",".join(input_list[start:end])),
